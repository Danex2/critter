...
const pets = [
  {
    ...
    breed: 'Pitbull',
    image:
      'https://images.unsplash.com/photo-1519963183664-2adcfeb55889?ixlib=rb-1.2.1&w=1000&q=80',
    lastSeen: {
      date: new Date(),
      location: {
        lat: 45,
  ...
  },
  {
    ...
    breed: 'Shihtzu',
    image:
      'https://www.pets4homes.co.uk/images/articles/1532/large/five-useful-things-to-know-about-the-shih-tzu-puppy-5ce28dbbd4f12.jpg',
    lastSeen: {
      date: new Date(),
      location: {
        lat: 45,
  ...
  describe('/pet/:id', () => {
    ...
    beforeEach(async () => {
      pet = await Pet.create({
        ...
        breed: 'Jarman',
        image:
          'https://dogzone-tcwebsites.netdna-ssl.com/wp-content/uploads/2018/07/german-shepherd-price-5.jpg',
        lastSeen: {
          date: new Date(),
          location: {
            lat: 45,
